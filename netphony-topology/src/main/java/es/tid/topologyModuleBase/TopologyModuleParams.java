...
public class TopologyModuleParams {
    ...
    /**
     * If a TCP socket, sending OSPF packets over it is used to receive
     * topology.
     */
     ...
     * ALTO
     */
    private String altoServer;
    private String altoServerPort;
    private String altoNeo4j;
    private String altoNeo4jPort;
    private String altoNetworkMapURL;
    private String altoNetworkMapContentType;
    private String altoNetworkMapName;
    ...
    public void initialize() {
        try {
            ...
            mangementPort = Integer
                    .parseInt((getCharacterDataFromElement((Element) doc
                            .getElementsByTagName("mangementPort").item(0))));
            mangementIP = getCharacterDataFromElement((Element) doc
                    .getElementsByTagName("mangementIP").item(0));

            NodeList list_nodes_OSPF = doc.getElementsByTagName("OSPF");
            Element nodes_OSPF = (Element) list_nodes_OSPF.item(0);

            OSPFSession = Boolean
                    .parseBoolean((getCharacterDataFromElement((Element) nodes_OSPF
                            .getElementsByTagName("OSPFSession").item(0))));
            OSPFListenerIP = getCharacterDataFromElement((Element) nodes_OSPF
                    .getElementsByTagName("OSPFListenerIP").item(0));
            reachabilityFile = getCharacterDataFromElement((Element) nodes_OSPF
                    .getElementsByTagName("reachabilityFile").item(0));
            OSPFMulticast = Boolean
                    .parseBoolean((getCharacterDataFromElement((Element) nodes_OSPF
                            .getElementsByTagName("OSPFMulticast").item(0))));
            OSPFUnicast = Boolean
                    .parseBoolean((getCharacterDataFromElement((Element) nodes_OSPF
                            .getElementsByTagName("OSPFUnicast").item(0))));
            OSPFTCPSession = Boolean
                    .parseBoolean((getCharacterDataFromElement((Element) nodes_OSPF
                            .getElementsByTagName("OSPFTCPSession").item(0))));

            NodeList list_nodes_Openflow = doc.getElementsByTagName("Openflow");
            Element nodes_Openflow = (Element) list_nodes_Openflow.item(0);

            controllerIP = getCharacterDataFromElement((Element) nodes_Openflow
                    .getElementsByTagName("ControllerIP").item(0));
            controllerPORT = getCharacterDataFromElement((Element) nodes_Openflow
                    .getElementsByTagName("ControllerPort").item(0));
            topologyLinksPath = getCharacterDataFromElement((Element) nodes_Openflow
                    .getElementsByTagName("ControllerTopoQueryLinks").item(0));
            topologyNodesPath = getCharacterDataFromElement((Element) nodes_Openflow
                    .getElementsByTagName("ControllerTopoQueryNodes").item(0));
            controllerListFile = getCharacterDataFromElement((Element) nodes_Openflow
                    .getElementsByTagName("controllerListFile").item(0));
            interDomainFile = getCharacterDataFromElement((Element) nodes_Openflow
                    .getElementsByTagName("interDomainFile").item(0));
            ...
            if (list_nodes_xml != null) {
                ...
                // Mode
                modexml = getCharacterDataFromElement((Element) nodes_xml
     ...
     * 
     * @param isBGPLSReaderWriting
     *            True if the current object is reader/writer, false if not.
     */
     ...
     * ALTO
     */
    public String getAltoServer() {
        return altoServer;
    }

    public void setAltoServer(String altoServer) {
        this.altoServer = altoServer;
    }

    public String getAltoServerPort() {
        return altoServerPort;
    }

    public void setAltoServerPort(String altoServerPort) {
        this.altoServerPort = altoServerPort;
    }

    public String getAltoNeo4j() {
        return altoNeo4j;
    }

    public void setAltoNeo4j(String altoNeo4j) {
        this.altoNeo4j = altoNeo4j;
    }

    public String getAltoNeo4jPort() {
        return altoNeo4jPort;
    }

    public void setAltoNeo4jPort(String altoNeo4jPort) {
        this.altoNeo4jPort = altoNeo4jPort;
    }

    public String getAltoNetworkMapURL() {
        return altoNetworkMapURL;
    }

    public void setAltoNetworkMapURL(String altoNetworkMapURL) {
        this.altoNetworkMapURL = altoNetworkMapURL;
    }

    public String getAltoNetworkMapContentType() {
        return altoNetworkMapContentType;
    }

    public void setAltoNetworkMapContentType(String altoNetworkMapContentType) {
        this.altoNetworkMapContentType = altoNetworkMapContentType;
    }

    public String getAltoNetworkMapName() {
        return altoNetworkMapName;
    }

    public void setAltoNetworkMapName(String altoNetworkMapName) {
        this.altoNetworkMapName = altoNetworkMapName;
    }
}
