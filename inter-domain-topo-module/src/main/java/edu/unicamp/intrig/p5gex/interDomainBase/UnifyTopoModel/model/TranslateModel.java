...
public class TranslateModel {
    ...
    public static Port translateNode(DomainTEDB db, edu.unicamp.intrig.p5gex.tedb.elements.Node n) {
        Port port = new Port();
        port.setId(((edu.unicamp.intrig.p5gex.tedb.elements.Node) n).getNodeID());
        return port;
    }
    ...
    public static Node translateTopology(String domainID, DomainTEDB ted) {
        ...
        for (Object nodeFromTed : ted.getIntraDomainLinksvertexSet()) {
            if (nodeFromTed instanceof edu.unicamp.intrig.p5gex.tedb.elements.Node) {
                portlist.add(translateNode(ted,
                        (edu.unicamp.intrig.p5gex.tedb.elements.Node) nodeFromTed));
