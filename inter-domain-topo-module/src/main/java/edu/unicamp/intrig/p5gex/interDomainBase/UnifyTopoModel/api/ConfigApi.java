package edu.unicamp.intrig.p5gex.interDomainBase.UnifyTopoModel.api;
...
import edu.unicamp.intrig.p5gex.interDomainBase.UnifyTopoModel.api.factories.ConfigApiServiceFactory;
...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Internal Error", response = VirtualizerSchema.class) })
    public Response topologyFromTADS(@Context SecurityContext securityContext)
    throws NotFoundException {        
        return delegate.topologyFromTADS(securityContext);
    }
    @GET
    @Path("/topologyFromALTO/")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Retrieve virtualizer", notes = "Retrieve operation of resource: virtualizer", response = VirtualizerSchema.class, tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Internal Error", response = VirtualizerSchema.class) })
    public Response topologyFromALTO(@Context SecurityContext securityContext)
    throws NotFoundException {        
