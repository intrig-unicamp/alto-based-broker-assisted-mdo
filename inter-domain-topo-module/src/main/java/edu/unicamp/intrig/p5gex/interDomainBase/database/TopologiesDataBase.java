...
public class TopologiesDataBase implements TopologyTEDB
{
	...
	@Override
    public void initializeFromTADS(VirtualizerSchema objTopology, String ID, Boolean test)
    {
	    teds.putAll(FileTEDBUpdater.readMultipleDomainSimpleNetworks(objTopology, null, false,0,Integer.MAX_VALUE, false, ID));
        mdTed.initializeFromTADS(objTopology, ID);
    }
