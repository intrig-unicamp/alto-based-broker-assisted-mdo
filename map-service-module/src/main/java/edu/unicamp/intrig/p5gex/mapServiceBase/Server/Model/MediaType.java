...
public class MediaType {
     ...
     *
     * The media types defined here should be identical to those generated by
     * alto-model, the main reason we need this is the ones defined here are
     * *STRING LITERALS*.
     * */
    ...
    public static final String ALTO_PROPERTYMAP = "application/alto-propertymap+json";
    public static final String ALTO_PROPERTYMAP_FILTER = "application/alto-propertymapfilter+json";
